...
This module defines the FNNSettings and FNNHyperparameters classes, which consolidate all configuration parameters to train an FNN.
...
class FNNSettings:
    ...
    # Model Definitions:
    model_suffix: str = "Identification_Test_Trial1"
    ...
    scheduler_patience: int = 8        # Number of epochs with no improvement after which learning rate will be reduced
