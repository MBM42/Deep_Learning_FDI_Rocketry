...
This script provides a framework for finding optimal hyperparameters for FNN_main.py
...
from FNN_Optimization import *

# ─── OUTPUT FILE NAME ───
current_dir = os.path.dirname(os.path.abspath(__file__))
timestamp = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
OUTPUT_DIR  = os.path.join(current_dir, "FNN_Optimizations", f"FNN_{timestamp}")
os.makedirs(OUTPUT_DIR, exist_ok=True)
OUTPUT_FILE = os.path.join(OUTPUT_DIR, f"FNN_Opt.txt")
