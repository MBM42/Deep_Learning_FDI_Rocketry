"""
LSTM_Optimization.py

Module to optimize the LSTM Hyperparameters with Optuna.
...
# LSTM Architecture
from LSTM_main import LSTMModel
...
def train_and_evaluate(
    ...
    """
    Train the LSTM for a fixed number of epochs and evaluate on the validation set.
    ...
    input_dim = len(npy_data.selected_features)
    model = LSTMModel(
        input_dim,
    ...
    for epoch in range(hyperparams.num_epochs):
        ...
        metrics['val_f1'] = f1_score(y_true_m,        y_pred_m, average='micro', zero_division=0.0)
